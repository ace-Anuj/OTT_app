...
import { fallbackMoviePoster, imagew500 } from '../api/moviedb';
...
const TrendingMovies = ({data}) => {
    ...
    const handleClick=(item)=>{
        navigation.navigate(SCREENS.MOVIESCREEN,item);
    }
  return (
    <View className='mb-8'>
...
const MovieCard =({item,handleClick})=>{
    ...
    return(
        <TouchableWithoutFeedback onPress={handleClick}>
            ...
            source ={{uri : imagew500(item.poster_path) || fallbackMoviePoster}}
